...
#endif
void
CURVE25519_FN(curve25519_donna_keypair) (curve25519_key mypublic, curve25519_key mysecret)
{
  randombytes(mysecret, 32);
  curve25519_donna_basepoint(mypublic, mysecret);
}
